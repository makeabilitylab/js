...
export { Cell, Grid, LineBreakTransformer, LineSegment, MORPH_PATHS, MakeabilityLabLogo, MakeabilityLabLogoColorer, MakeabilityLabLogoGridFade, MakeabilityLabLogoLeafFall, MakeabilityLabLogoMorpher, MakeabilityLabLogoZoomFade, ORIGINAL_COLOR_ARRAY, OriginalColorPaletteRGB, Serial, SerialEvents, SerialState, Triangle, TriangleArt, TriangleDir, Vector, arcPath, bezierPath, changeColorBrightness, changeColorSaturationAndBrightness, clamp, constrain, convertColorStringToObject, convertToDegrees, convertToRadians, easeInCubic, easeInOutCubic, easeOutBack, easeOutCubic, easeOutQuad, hexStringToRgb, hsvToRgb, lerp, lerpColor, linearPath, map, parseHexString, random, randomGaussian, rgbToHex, rgbToHsv, shuffle, spiralPath };
